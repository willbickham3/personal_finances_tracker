...
const IncomePage = () => {
    ...
    const getIncome = async () => {
        ...
        console.log(user_id)
        try {
            const response = await fetch(`https://personal-finances-tracker-1.onrender.com/api/income/${user_id}`, {
                method: 'GET', 
            });
    ...
    const addIncome = async (amount, source, date) => {
        ...
        try {
            ...
            const response = await fetch('https://personal-finances-tracker-1.onrender.com/api/income', {
                method: 'POST',
                headers: {
    ...
    const deleteIncome = async (user_id, id) => {
        ...
        try {
            const response = await fetch(`https://personal-finances-tracker-1.onrender.com/api/income/${user_id}/${id}`, {
                method: 'DELETE',
                // headers: {
