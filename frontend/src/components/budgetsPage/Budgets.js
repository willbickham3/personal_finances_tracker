...
const BudgetPage = () => {
    ...
    const getBudgets = async () => {
        ...
        console.log(user_id)
        try {
            const response = await fetch(`http://localhost:5003/api/budgets/${user_id}`, {
                method: 'GET', 
            });
    ...
    const addBudget = async (currentAmount, amount, category, date) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5003/api/budgets/', {
                method: 'POST',
                headers: {
    ...
    const deleteBudget = async (user_id, id) => {
        ...
        try {
            const response = await fetch(`http://localhost:5003/api/budgets/${user_id}/${id}`, {
                method: 'DELETE',
                // headers: {
